...
const LargeLogo = () => {
    ...
    const { dict: { logoPt1, logoPt2 }, isRTL } = useSettingsStore()

  return (
      <div className={`max-xl:hidden max-md:min-h-[calc(100vh-250px)] text-(--theme2) font-extrabold flex flex-col items-center justify-center gap-10 max-md:gap-[0.8rem] max-sm:gap-2`}>
